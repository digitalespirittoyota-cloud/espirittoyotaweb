...
//           <div className="p-6 md:p-14 md:pt-20 text-gray-700">
...
//           {/* CONTROLS */}
//           <div className="relative md:absolute md:bottom-10 md:left-14 px-6 pb-6 md:p-0 flex items-center gap-3 text-gray-700">
//             <button onClick={() => setActive((active - 1 + slides.length) % slides.length)}>‹</button>
...
//                 ${active === i ? "border-gray-800" : "border-gray-300 text-gray-400"}`}
//               >
//                 {i + 1}
//               </button>
//             ))}

//             <button onClick={() => setActive((active + 1) % slides.length)}>›</button>
//           </div>
//         </div>
