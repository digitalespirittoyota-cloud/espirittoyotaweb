...
//   return (
//     <section className="relative w-full h-[70vh] sm:h-[80vh] lg:h-[85vh] overflow-hidden bg-white">
//       {/* DESKTOP IMAGE */}
//       <Image
//         src={image}
//         alt={title}
...
//       {/* RIGHT TOP DIAGONAL CUT (smaller on mobile) */}
//       <div
//         className="
//           absolute top-0 right-0 bg-white z-20
//           w-16 h-16
//           sm:w-24 sm:h-24
//           lg:w-36 lg:h-36
//         "
...
//       {/* LEFT BOTTOM DIAGONAL CUT (smaller on mobile) */}
//       <div
//         className="
//           absolute bottom-0 left-0 bg-white z-20
//           w-16 h-16
//           sm:w-24 sm:h-24
//           lg:w-36 lg:h-36
//         "
